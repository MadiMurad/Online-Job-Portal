 ...
 
{
	...
	$xyz="select * from employee where email='$user' and password='$pass' and user_type='User'";
		...
		<section>
			<div class="panel panel-default top caja">
			  <div class="panel-body">
			    <h3 class="text-center"> Job Seekers Login</h3>
				<hr>
			    ...
			    <form method="post">
					...
					<br>
					 ...
					 <a href="forget.php" class="btn btn-block btn-warning">Forget Password</a>
